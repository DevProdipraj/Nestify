        ...
        <div className="container relative">
          <div className="flex items-center justify-between md:mx-6">
            ...
            <div className="flex items-center justify-center space-x-3 md:space-x-5">
              <div className="hidden md:block">
                <div className="flex items-center justify-center md:space-x-5">
                  <IoSearchSharp size={25} className="text-[#6a6a6a] font-bold cursor-pointer" />
            ...
            <div className="md:hidden cursor-pointer" onClick={() => setIsOpen(!isOpen)}>
              <RiMenu2Line className="text-dark cursor-pointer" size={25} />
            </div>
          </div>
          ...
          {isOpen && (
            <div className="fixed inset-0 z-40 bg-neutral bg-opacity-50 md:hidden" onClick={() => setIsOpen(false)}></div>
          )}

          <div className={`fixed inset-y-0 left-0 z-50 h-screen w-3/4 max-w-sm transform bg-white p-6 shadow-lg transition-transform duration-300 ease-in-out md:hidden ${isOpen ? "translate-x-0" : "-translate-x-full"}`}>
            <div className="mb-6 flex justify-end">
              <IoIosCloseCircleOutline size={30} className="cursor-pointer text-gray-600" onClick={() => setIsOpen(false)} />
            </div>
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={item.name} onClick={() => setIsOpen(false)}>
                  <Link href={item.href} className="block text-lg font-medium text-gray-800 hover:text-primary">
                    {item.name}
                  </Link>
                </li>
              ))}
